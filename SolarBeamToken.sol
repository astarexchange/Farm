...
contract SolarBeamToken is ERC20, ERC20Permit, Pausable, AccessControl {
    ...
    uint256 private _maxSupply = 250000000 * 10**decimals(); // maximum supply
    uint256 private _initialSupply = 50000000 * 10**decimals(); // initial supply
    ...
    constructor(address trustedForwarder) ERC20("AstarX Token", "ASX") ERC20Permit("AstarX Token") {
